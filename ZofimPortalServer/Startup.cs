...
namespace ZofimPortalServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = this.Configuration.GetConnectionString("ZofimPortalDB");
            services.AddDbContext<ZofimPortalDBContext>(options => options.UseSqlServer(connectionString));
        }
